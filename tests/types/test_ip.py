...
class IPv4TestCase(BaseTestCase):
    ...
    def test_select_where_address(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                ...
                .filter(self.table.c.x == IPv4Address("10.0.0.1"))
                .scalar(),
                a,
            )
            self.assertEqual(
    ...
    def test_select_in_network(self):
        ...
        with self.create_table(self.table):
            self.session.execute(
                self.table.insert(), [{"x": ip} for ip in ips]
            )

            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(self.table.c.x.in_(IPv4Network("10.0.0.0/8")))
                .all(),
                [
                    (IPv4Address("10.0.0.1"),),
                    (IPv4Address("10.0.0.2"),),
    ...
    def test_select_in_list_network(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(self.table.c.x.in_(["10.0.0.0/24", "10.1.0.0/24"]))
                .all(),
                [
                    (IPv4Address("10.0.0.1"),),
                    (IPv4Address("10.0.0.2"),),
    ...
    def test_select_in_list_network_and_address(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(self.table.c.x.in_(["10.0.0.0/24", "10.1.0.3"]))
                .all(),
                [
                    (IPv4Address("10.0.0.1"),),
                    (IPv4Address("10.0.0.2"),),
    ...
    def test_select_in_string(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(self.table.c.x.in_("10.0.0.0/8"))
                .all(),
                [
                    (IPv4Address("10.0.0.1"),),
                    (IPv4Address("10.0.0.2"),),
    ...
    def test_select_not_in_network(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(self.table.c.x.notin_(IPv4Network("10.0.0.0/8")))
                .all(),
                [(IPv4Address("192.168.0.1"),)],
            )
            self.assertEqual(
    ...
    def test_select_not_in_string(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(self.table.c.x.notin_("10.0.0.0/8"))
                .all(),
                [(IPv4Address("192.168.0.1"),)],
            )
            self.assertEqual(
    ...
    def test_select_not_in_list_address(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(self.table.c.x.notin_(["10.0.0.2", "10.1.0.3"]))
                .all(),
                [(IPv4Address("10.0.0.1"),), (IPv4Address("192.168.0.1"),)],
            )
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(~self.table.c.x.in_(["10.0.0.2", "10.1.0.3"]))
                .all(),
                [(IPv4Address("10.0.0.1"),), (IPv4Address("192.168.0.1"),)],
            )
    ...
    def test_select_not_in_list_network(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(self.table.c.x.notin_(["10.0.0.0/24", "10.1.0.0/24"]))
                .all(),
                [(IPv4Address("192.168.0.1"),)],
            )
            self.assertEqual(
    ...
    def test_select_not_in_list_network_address(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(self.table.c.x.notin_(["10.0.0.0/24", "10.1.0.3"]))
                .all(),
                [(IPv4Address("192.168.0.1"),)],
            )
            self.assertEqual(
...
class IPv6TestCase(BaseTestCase):
    ...
    def test_select_insert_string(self):
        ...
        with self.create_table(self.table):
            self.session.execute(self.table.insert(), [{"x": a}])
            self.assertEqual(
                self.session.query(self.table.c.x).scalar(), IPv6Address(a)
            )
    ...
    def test_select_where_address(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(self.table.c.x == IPv6Address("42e::2"))
                .scalar(),
                a,
            )
    ...
    def test_select_where_string(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(
                    and_("42e::1" < self.table.c.x, self.table.c.x < "42e::3")
                )
                .scalar(),
                a,
            )
    ...
    def test_select_in_network(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(self.table.c.x.in_(IPv6Network("42e::/64")))
                .all(),
                [
                    (IPv6Address("42e::1"),),
                    (IPv6Address("42e::2"),),
    ...
    def test_select_in_list_address(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(self.table.c.x.in_(["42e::1", "42e::2", "f42e::ffff"]))
                .all(),
                [
                    (IPv6Address("42e::1"),),
                    (IPv6Address("42e::2"),),
    ...
    def test_select_in_list_network(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                ...
                .filter(
                    self.table.c.x.in_(
                        [IPv6Network("42e::/64"), IPv6Network("a42e::/48")]
                    )
                )
                .all(),
                [
    ...
    def test_select_in_list_network_address(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(self.table.c.x.in_(["42e::/64", "a42e::3"]))
                .all(),
                [
                    (IPv6Address("42e::1"),),
                    (IPv6Address("42e::2"),),
    ...
    def test_select_in_string(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(self.table.c.x.in_("42e::/64"))
                .all(),
                [
                    (IPv6Address("42e::1"),),
                    (IPv6Address("42e::2"),),
    ...
    def test_select_not_in_network(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(self.table.c.x.notin_(IPv6Network("42e::/64")))
                .all(),
                [(IPv6Address("f42e::ffff"),)],
            )
            self.assertEqual(
    ...
    def test_select_not_in_string(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(self.table.c.x.notin_("42e::/64"))
                .all(),
                [(IPv6Address("f42e::ffff"),)],
            )
            self.assertEqual(
    ...
    def test_select_not_in_list_address(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(self.table.c.x.notin_(["42e::1", "42e::3"]))
                .all(),
                [
                    (IPv6Address("42e::2"),),
                    (IPv6Address("f42e::ffff"),),
            ...
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(~self.table.c.x.in_(["42e::1", "42e::3"]))
                .all(),
                [
                    (IPv6Address("42e::2"),),
                    (IPv6Address("f42e::ffff"),),
    ...
    def test_select_not_in_list_network(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(self.table.c.x.notin_(["42e::/64", "beef::/64"]))
                .all(),
                [(IPv6Address("1234::1"),), (IPv6Address("f42e::ffff"),)],
            )
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(~self.table.c.x.in_(["42e::/64", "beef::/64"]))
                .all(),
                [(IPv6Address("1234::1"),), (IPv6Address("f42e::ffff"),)],
            )
    ...
    def test_select_not_in_list_network_address(self):
        ...
        with self.create_table(self.table):
            ...
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(self.table.c.x.notin_(["42e::/64", "beef::3"]))
                .all(),
                [(IPv6Address("1234::1"),), (IPv6Address("f42e::ffff"),)],
            )
            self.assertEqual(
                self.session.query(self.table.c.x)
                .filter(~self.table.c.x.in_(["42e::/64", "beef::3"]))
                .all(),
                [(IPv6Address("1234::1"),), (IPv6Address("f42e::ffff"),)],
            )
